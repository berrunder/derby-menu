...
app.on('model', function(model) {
    ...
    model.fn('getTotalOrder', function(users, courses) {
        ...
        for (var i = users.length; i--;) {
            ...
            // посчитаем хлеб
            var currentWhite = parseInt(users[i].bread.white || 0),
                currentBlack = parseInt(users[i].bread.black || 0);
    ...
    var getBreadSum = function(user) {
        ...
        var white = parseInt(user.bread.white || 0),
            black = parseInt(user.bread.black || 0);
